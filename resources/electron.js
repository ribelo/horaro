...
cljs.core.into_array = function(a) {
  switch(arguments.length) {
    ...
    default:
      throw Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "), cljs.core.str.cljs$core$IFn$_invoke$arity$1(arguments.length)].join(""));
  }
};
...
cljs.core.iter_reduce.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  ...
  if (cljs.core.truth_(c.hasNext())) {
    for (var d = c.next();;) {
      if (c.hasNext()) {
        var e = c.next(), d = b.cljs$core$IFn$_invoke$arity$2 ? b.cljs$core$IFn$_invoke$arity$2(d, e) : b.call(null, d, e);
        if (cljs.core.reduced_QMARK_(d)) {
          return cljs.core.deref(d);
        }
      } else {
...
cljs.core.hash_imap = function(a) {
  ...
  for (a = cljs.core.seq(a);;) {
    if (a) {
      var c = cljs.core.first(a), b = (b + (cljs.core.hash(cljs.core.key(c)) ^ cljs.core.hash(cljs.core.val(c)))) % 4503599627370496;
      a = cljs.core.next(a);
    } else {
      return b;
    }
...
cljs.core.extend_object_BANG_ = function(a, b) {
  for (var c = cljs.core.seq(b), d = null, e = 0, f = 0;;) {
    if (f < e) {
      var g = d.cljs$core$IIndexed$_nth$arity$2(null, f), h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(g, 0, null), g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(g, 1, null), h = cljs.core.name(h);
      a[h] = g;
      f += 1;
    } else {
      if (c = cljs.core.seq(c)) {
        cljs.core.chunked_seq_QMARK_(c) ? (e = cljs.core.chunk_first(c), c = cljs.core.chunk_rest(c), d = e, e = cljs.core.count(e)) : (e = cljs.core.first(c), d = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(e, 0, null), e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(e, 1, null), d = cljs.core.name(d), a[d] = e, c = cljs.core.next(c), d = null, e = 0), f = 0;
      } else {
        break;
      }
    }
...
cljs.core.apply_to = function(a, b, c) {
  ...
  var x = cljs.core._first(y), E = cljs.core._rest(y);
  if (18 === b) {
...
cljs.core.apply_to_simple.cljs$core$IFn$_invoke$arity$6 = function(a, b, c, d, e, f) {
  ...
  var n = cljs.core._first(p), q = cljs.core.next(p);
  if (null == q) {
  ...
  var p = cljs.core._first(q), r = cljs.core.next(q);
  if (null == r) {
  ...
  var q = cljs.core._first(r), t = cljs.core.next(r);
  if (null == t) {
  ...
  var r = cljs.core._first(t), u = cljs.core.next(t);
  if (null == u) {
  ...
  var t = cljs.core._first(u), v = cljs.core.next(u);
  if (null == v) {
  ...
  var u = cljs.core._first(v), w = cljs.core.next(v);
  if (null == w) {
  ...
  var v = cljs.core._first(w), x = cljs.core.next(w);
  if (null == x) {
  ...
  var w = cljs.core._first(x), y = cljs.core.next(x);
  if (null == y) {
  ...
  var x = cljs.core._first(y), E = cljs.core.next(y);
  if (null == E) {
...
cljs.core.nil_iter = function() {
  "undefined" === typeof cljs.core.t_cljs$core10826 && (cljs.core.t_cljs$core10826 = function(a) {
    this.meta10827 = a;
    this.cljs$lang$protocol_mask$partition0$ = 393216;
    this.cljs$lang$protocol_mask$partition1$ = 0;
  }, cljs.core.t_cljs$core10826.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
    return new cljs.core.t_cljs$core10826(b);
  }, cljs.core.t_cljs$core10826.prototype.cljs$core$IMeta$_meta$arity$1 = function(a) {
    return this.meta10827;
  }, cljs.core.t_cljs$core10826.prototype.hasNext = function() {
    return !1;
  }, cljs.core.t_cljs$core10826.prototype.next = function() {
    return Error("No such element");
  }, cljs.core.t_cljs$core10826.prototype.remove = function() {
    return Error("Unsupported operation");
  }, cljs.core.t_cljs$core10826.getBasis = function() {
    return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null, "meta10827", "meta10827", -310430637, null)], null);
  }, cljs.core.t_cljs$core10826.cljs$lang$type = !0, cljs.core.t_cljs$core10826.cljs$lang$ctorStr = "cljs.core/t_cljs$core10826", cljs.core.t_cljs$core10826.cljs$lang$ctorPrWriter = function(a, b, c) {
    return cljs.core._write(b, "cljs.core/t_cljs$core10826");
  }, cljs.core.__GT_t_cljs$core10826 = function(a) {
    return new cljs.core.t_cljs$core10826(a);
  });
  return new cljs.core.t_cljs$core10826(cljs.core.PersistentArrayMap.EMPTY);
};
...
cljs.core.Many.prototype.toString = function() {
  return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("Many: "), cljs.core.str.cljs$core$IFn$_invoke$arity$1(this.vals)].join("");
};
...
cljs.core.Single.prototype.remove = function() {
  if (this.val === cljs.core.NONE) {
    throw Error("" + cljs.core.str.cljs$core$IFn$_invoke$arity$1("Removing object from empty buffer"));
  }
  var a = this.val;
...
cljs.core.Single.prototype.toString = function() {
  return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("Single: "), cljs.core.str.cljs$core$IFn$_invoke$arity$1(this.val)].join("");
};
...
cljs.core.TransformerIterator.create = function(a, b) {
  return cljs.core.transformer_iterator(a, cljs.core.iter(b), !1);
};
cljs.core.TransformerIterator.createMulti = function(a, b) {
  ...
  return cljs.core.transformer_iterator(a, new cljs.core.MultiIterator(c), !0);
};
...
cljs.core.sequence.cljs$core$IFn$_invoke$arity$2 = function(a, b) {
  var c = cljs.core.chunkIteratorSeq(cljs.core.TransformerIterator.create(a, b));
  return cljs.core.truth_(c) ? c : cljs.core.List.EMPTY;
};
cljs.core.sequence.cljs$core$IFn$_invoke$arity$variadic = function(a, b, c) {
  a = cljs.core.chunkIteratorSeq(cljs.core.TransformerIterator.createMulti(a, cljs.core.to_array(cljs.core.cons(b, c))));
...
cljs.core.PersistentHashMap.prototype.cljs$core$IFind$_find$arity$2 = function(a, b) {
  return null == b ? this.has_nil_QMARK_ ? new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null, this.nil_val], null) : null : this.root.inode_find(0, cljs.core.hash(b), b, null);
};
  ...
  return function c(a, e) {
    return new cljs.core.LazySeq(null, function() {
      ...
      a: {
        var g = a;
        for (d = e;;) {
          var h = g, g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(h, 0, null);
...
cljs.core.pr_writer_impl = function(a, b, c) {
  ...
  if (goog.isFunction(a)) {
    ...
    return cljs.core.write_all.cljs$core$IFn$_invoke$arity$variadic(b, cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["#object[", c, ' "', "" + cljs.core.str.cljs$core$IFn$_invoke$arity$1(a), '"]'], 0));
  }
...
cljs.core.Eduction.prototype.cljs$core$IIterable$_iterator$arity$1 = function(a) {
  return cljs.core.TransformerIterator.create(this.xform, this);
};
...
app.core.app.on("window-all-closed", function() {
  return cljs.core._EQ_.call(null, process.platform, "darwin") ? null : app.core.app.quit();
});
