...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8431__auto__,writer__8432__auto__,opt__8433__auto__){
return cljs.core._write.call(null,writer__8432__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__11020 = o;
(G__11020[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__11022__i < G__11022__a.length) {G__11022__a[G__11022__i] = arguments[G__11022__i + 0]; ++G__11022__i;}
  args = new cljs.core.IndexedSeq(G__11022__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__7762__auto__ = !((jsprops == null));
if(and__7762__auto__){
var and__7762__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__11026 = jsprops;
(G__11026["defaultValue"] = value);

(G__11026["onChange"] = ((function (G__11026,v,value,on_change){
return (function (p1__11025_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11025_SHARP_);
});})(G__11026,v,value,on_change))
);
...
var vec__11029 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11029,(0),null);
var id = cljs.core.nth.call(null,vec__11029,(1),null);
var class$ = cljs.core.nth.call(null,vec__11029,(2),null);
...
var jsprops = ({"argv": v});
var temp__6757__auto___11033 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6757__auto___11033 == null)){
} else {
var key_11034 = temp__6757__auto___11033;
(jsprops["key"] = key_11034);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__11035 = (new reagent.impl.template.NativeWrapper());
(G__11035["name"] = c);
...
var len__9007__auto___11040 = arguments.length;
var i__9008__auto___11041 = (0);
while(true){
if((i__9008__auto___11041 < len__9007__auto___11040)){
args__9014__auto__.push((arguments[i__9008__auto___11041]));

var G__11042 = (i__9008__auto___11041 + (1));
i__9008__auto___11041 = G__11042;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9015__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11038){
var G__11039 = cljs.core.first.call(null,seq11038);
var seq11038__$1 = cljs.core.next.call(null,seq11038);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__11039,seq11038__$1);
});
...
break;
default:
var G__11045 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__11045;
continue;
...
var n__8796__auto___11047 = a.length;
var i_11048 = (0);
while(true){
if((i_11048 < n__8796__auto___11047)){
(a[i_11048] = reagent.impl.template.as_element.call(null,(a[i_11048])));
...
var a = cljs.core.into_array.call(null,s);
var n__8796__auto___11050 = a.length;
var i_11051 = (0);
while(true){
if((i_11051 < n__8796__auto___11050)){
var val_11052 = (a[i_11051]);
if((cljs.core.vector_QMARK_.call(null,val_11052)) && ((reagent.impl.template.key_from_vec.call(null,val_11052) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11051] = reagent.impl.template.as_element.call(null,val_11052));
...
var ctx = ({});
var vec__11054 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11054,(0),null);
var derefed = cljs.core.nth.call(null,vec__11054,(1),null);
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__11057){
...
//# sourceMappingURL=template.js.map?rel=1504091217697