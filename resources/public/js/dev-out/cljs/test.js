...
return cljs.core.assoc.call(null,G__14534,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14534;
}
});
...
var or__7774__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__9007__auto___14539 = arguments.length;
var i__9008__auto___14540 = (0);
while(true){
if((i__9008__auto___14540 < len__9007__auto___14539)){
args__9014__auto__.push((arguments[i__9008__auto___14540]));

var G__14541 = (i__9008__auto___14540 + (1));
i__9008__auto___14540 = G__14541;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9015__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14536){
var G__14537 = cljs.core.first.call(null,seq14536);
var seq14536__$1 = cljs.core.next.call(null,seq14536);
var G__14538 = cljs.core.first.call(null,seq14536__$1);
var seq14536__$2 = cljs.core.next.call(null,seq14536__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__14537,G__14538,seq14536__$2);
});
...
var map__14543 = m;
var map__14543__$1 = ((((!((map__14543 == null)))?((((map__14543.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14543.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14543):map__14543);
var file = cljs.core.get.call(null,map__14543__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14543__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14543__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14543,map__14543__$1,file,line,column){
return (function (p1__14542_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14542_SHARP_));
});})(map__14543,map__14543__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__8806__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__8806__auto__,prefer_table__8807__auto__,method_cache__8808__auto__,cached_hierarchy__8809__auto__,hierarchy__8810__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__7774__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
} else {
...
var temp__6753__auto___14545 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6753__auto___14545)){
var message_14546 = temp__6753__auto___14545;
...
var temp__6753__auto___14547 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__6753__auto___14547)){
var message_14548 = temp__6753__auto___14547;
cljs.core.println.call(null,message_14548);
} else {
}
...
var temp__6751__auto__ = (function (){var and__7762__auto__ = typeof exception.stack === 'string';
if(and__7762__auto__){
var G__14550 = exception.stack;
var G__14550__$1 = (((G__14550 == null))?null:clojure.string.split_lines.call(null,G__14550));
var G__14550__$2 = (((G__14550__$1 == null))?null:cljs.core.get.call(null,G__14550__$1,depth));
if((G__14550__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14550__$2);
}
} else {
...
var vec__14551 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14551,(0),null);
var column = cljs.core.nth.call(null,vec__14551,(1),null);
var vec__14554 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14554,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14554,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14554,(2),null);
...
var m__$1 = (function (){var G__14557 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14561 = (function (){var G__14560 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14560);
} else {
return G__14560;
}
})();
...
return cljs.core.vary_meta.call(null,G__14562,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14566 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14566,(0),null);
var types = vec__14566;
...
return cljs.core.map.call(null,(function (p__14569){
var vec__14570 = p__14569;
var ns = cljs.core.nth.call(null,vec__14570,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14570,(1),null);
return ((function (vec__14570,ns,vars__$1){
return (function (){
...
var G__14573 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1){
return (function (){
var seq__14574 = cljs.core.seq.call(null,vars__$1);
var chunk__14575 = null;
var count__14576 = (0);
var i__14577 = (0);
while(true){
if((i__14577 < count__14576)){
var v = cljs.core._nth.call(null,chunk__14575,i__14577);
var temp__6753__auto___14579 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6753__auto___14579)){
var t_14580 = temp__6753__auto___14579;
each_fixture_fn.call(null,((function (seq__14574,chunk__14575,count__14576,i__14577,t_14580,temp__6753__auto___14579,v,each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14580)));
});})(seq__14574,chunk__14575,count__14576,i__14577,t_14580,temp__6753__auto___14579,v,each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1))
);
} else {
}
...
var temp__6753__auto__ = cljs.core.seq.call(null,seq__14574);
if(temp__6753__auto__){
var seq__14574__$1 = temp__6753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14574__$1)){
var c__8686__auto__ = cljs.core.chunk_first.call(null,seq__14574__$1);
var G__14585 = cljs.core.chunk_rest.call(null,seq__14574__$1);
var G__14586 = c__8686__auto__;
var G__14587 = cljs.core.count.call(null,c__8686__auto__);
var G__14588 = (0);
seq__14574 = G__14585;
...
var v = cljs.core.first.call(null,seq__14574__$1);
var temp__6753__auto___14589__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__6753__auto___14589__$1)){
var t_14590 = temp__6753__auto___14589__$1;
each_fixture_fn.call(null,((function (seq__14574,chunk__14575,count__14576,i__14577,t_14590,temp__6753__auto___14589__$1,v,seq__14574__$1,temp__6753__auto__,each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14590)));
});})(seq__14574,chunk__14575,count__14576,i__14577,t_14590,temp__6753__auto___14589__$1,v,seq__14574__$1,temp__6753__auto__,each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1))
);
} else {
}

var G__14591 = cljs.core.next.call(null,seq__14574__$1);
var G__14592 = null;
var G__14593 = (0);
var G__14594 = (0);
seq__14574 = G__14591;
chunk__14575 = G__14592;
count__14576 = G__14593;
i__14577 = G__14594;
continue;
}
} else {
...
});})(each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1))
);
});})(each_fixture_fn,G__14573,G__14573__$1,env,once_fixtures,each_fixtures,vec__14570,ns,vars__$1))
], null);
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14573__$1)].join('')));

}
})());
});
;})(vec__14570,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1504091224142