...
goog.addDependency("../horaro/repl.js", ['horaro.repl'], ['cljs.core', 'cljs_time.core', 're_frame.core']);
goog.addDependency("../horaro/config.js", ['horaro.config'], ['cljs.core']);
goog.addDependency("../horaro/electron.js", ['horaro.electron'], ['cljs.core']);
...
goog.addDependency("../horaro/db/core.js", ['horaro.db.core'], ['goog.date.UtcDateTime', 'cljs.core', 'cognitect.transit', 're_frame.core']);
...
goog.addDependency("../horaro/calendar/utils.js", ['horaro.calendar.utils'], ['cljs.core', 'cljs_time.core', 'cljs_time.periodic', 're_frame.core']);
goog.addDependency("../semantic_ui/core.js", ['semantic_ui.core'], ['reagent.core', 'cljs.core', 'cuerdas.core']);
...
goog.addDependency("../horaro/flex.js", ['horaro.flex'], ['reagent.core', 'cljs.core', 'taoensso.encore', 'cljs.spec.alpha', 'cuerdas.core']);
goog.addDependency("../horaro/workers/ui.js", ['horaro.workers.ui'], ['reagent.ratom', 'reagent.core', 'cljs.core', 'semantic_ui.core', 're_frame.core', 'cuerdas.core', 'horaro.flex']);
goog.addDependency("../horaro/npm.js", ['horaro.npm'], ['reagent.core', 'cljs.core']);
goog.addDependency("../cljs_time/predicates.js", ['cljs_time.predicates'], ['cljs.core', 'cljs_time.core', 'cljs_time.coerce']);
goog.addDependency("../horaro/calendar/ui.js", ['horaro.calendar.ui'], ['horaro.npm', 'reagent.ratom', 'reagent.core', 'cljs.core', 'cljs_time.core', 'semantic_ui.core', 'cljs_time.periodic', 'cljs_time.format', 'taoensso.encore', 'cljs_time.predicates', 're_frame.core', 'cuerdas.core', 'horaro.flex']);
goog.addDependency("../horaro/workers/utils.js", ['horaro.workers.utils'], ['cljs.core']);
goog.addDependency("../horaro/ui.js", ['horaro.ui'], ['reagent.ratom', 'horaro.workers.ui', 'reagent.core', 'cljs.core', 'semantic_ui.core', 'horaro.calendar.ui', 'horaro.workers.utils', 're_frame.core', 'horaro.flex']);
goog.addDependency("../horaro/workers/db.js", ['horaro.workers.db'], ['cljs.core']);
goog.addDependency("../horaro/calendar/db.js", ['horaro.calendar.db'], ['cljs.core', 'cljs_time.core', 'cljs_time.periodic']);
goog.addDependency("../horaro/db/events.js", ['horaro.db.events'], ['horaro.workers.db', 'horaro.calendar.db', 'horaro.db.core', 'cljs.core', 're_frame.core']);
goog.addDependency("../horaro/workers/events.js", ['horaro.workers.events'], ['horaro.db.core', 'cljs.core', 're_frame.core', 'cuerdas.core']);
...
goog.addDependency("../horaro/calendar/events.js", ['horaro.calendar.events'], ['horaro.db.core', 'cljs.core', 'cljs_time.core', 'horaro.electron', 'cljs_time.periodic', 'taoensso.encore', 're_frame.core']);
goog.addDependency("../horaro/workers/subs.js", ['horaro.workers.subs'], ['cljs.core', 'cljs_time.core', 're_frame.core']);
goog.addDependency("../horaro/calendar/subs.js", ['horaro.calendar.subs'], ['reagent.ratom', 'cljs.core', 'cljs_time.core', 'horaro.calendar.utils', 'cljs_time.periodic', 'cljs_time.format', 're_frame.core']);
goog.addDependency("../horaro/init.js", ['horaro.init'], ['horaro.calendar.events', 'cljs.core', 'horaro.db.events', 'horaro.workers.events', 'horaro.workers.subs', 'horaro.calendar.subs']);
goog.addDependency("../horaro/fs.js", ['horaro.fs'], ['cljs.core', 'horaro.electron']);
goog.addDependency("../horaro/csv.js", ['horaro.csv'], ['cljs.core', 'clojure.string']);
goog.addDependency("../cljs/repl.js", ['cljs.repl'], ['cljs.core', 'cljs.spec.alpha']);
goog.addDependency("../horaro/core.js", ['horaro.core'], ['horaro.config', 'reagent.core', 'cljs.core', 'horaro.ui', 'horaro.init', 're_frame.core']);
...
goog.addDependency("../figwheel/connect/dev.js", ['figwheel.connect.dev'], ['cljs.core', 'horaro.core', 'figwheel.client', 'figwheel.client.utils']);
