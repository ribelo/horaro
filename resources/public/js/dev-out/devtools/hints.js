...
var reader = (function (){var or__7774__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__7774__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__29332__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__29332__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__29332__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__6751__auto___29334 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6751__auto___29334)){
var seen_errors_29335 = temp__6751__auto___29334;
if(cljs.core.truth_(seen_errors_29335.has(self))){
} else {
seen_errors_29335.add(self);

var temp__6753__auto___29336 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6753__auto___29336)){
var sense_29337 = temp__6753__auto___29336;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29337)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1504091240055