...
var G__28877 = devtools.prefs.pref.call(null,v);
v = G__28877;
continue;
} else {
return v;
...
var and__7762__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7762__auto__){
var and__7762__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7774__auto__ = (function (){try{if(!((value == null))){
...
}catch (e28880){var e__27076__auto__ = e28880;
return false;
}})();
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
} else {
var or__7774__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e28884){var e__27076__auto__ = e28884;
return false;
}})();
...
}catch (e28886){var e__27076__auto__ = e28886;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7762__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7762__auto__)){
var and__7762__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7762__auto____$1){
...
var and__7762__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7762__auto__)){
...
var or__7774__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
} else {
...
var and__7762__auto__ = (function (){var or__7774__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
} else {
...
var vec__28888 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28888,(0),null);
var name = cljs.core.nth.call(null,vec__28888,(1),null);
...
var and__7762__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7762__auto__)){
...
var or__7774__auto__ = typeof value === 'string';
if(or__7774__auto__){
return or__7774__auto__;
} else {
var or__7774__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__28891_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28891_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1504091239011