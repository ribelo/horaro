...
var len__9007__auto___28905 = arguments.length;
var i__9008__auto___28906 = (0);
while(true){
if((i__9008__auto___28906 < len__9007__auto___28905)){
args__9014__auto__.push((arguments[i__9008__auto___28906]));

var G__28907 = (i__9008__auto___28906 + (1));
i__9008__auto___28906 = G__28907;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9015__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28902){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__28903,G__28904,seq28902__$2);
});
...
if(cljs.core.truth_((function (){var or__7774__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8431__auto__,writer__8432__auto__,opt__8433__auto__){
return cljs.core._write.call(null,writer__8432__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7762__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7762__auto__){
var or__7774__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28908_SHARP_){
return !((cljs.core.meta.call(null,p1__28908_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__28909__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7774__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e28913){var e__27076__auto__ = e28913;
return false;
}})();
if(cljs.core.truth_(or__7774__auto__)){
return or__7774__auto__;
...
}catch (e28915){var e__27076__auto__ = e28915;
return false;
}}
})())){
...
var _STAR_current_state_STAR_28917 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__28918 = opts;
...
var markup_db = cljs.core.get.call(null,map__28918__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_28917;
}});
...
;
var temp__6751__auto___28922 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6751__auto___28922)){
var managed_print_level_28923 = temp__6751__auto___28922;
var _STAR_print_level_STAR_28921_28924 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_28923;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_28921_28924,managed_print_level_28923,temp__6751__auto___28922,writer,opts,job_fn){
return (function (p1__28920_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__28920_SHARP_,null);
});})(_STAR_print_level_STAR_28921_28924,managed_print_level_28923,temp__6751__auto___28922,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_28921_28924;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1504091239159