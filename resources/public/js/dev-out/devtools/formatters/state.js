...
var len__9007__auto___28896 = arguments.length;
var i__9008__auto___28897 = (0);
while(true){
if((i__9008__auto___28897 < len__9007__auto___28896)){
args__9014__auto__.push((arguments[i__9008__auto___28897]));

var G__28898 = (i__9008__auto___28897 + (1));
i__9008__auto___28897 = G__28898;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9015__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq28894){
var G__28895 = cljs.core.first.call(null,seq28894);
var seq28894__$1 = cljs.core.next.call(null,seq28894);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__28895,seq28894__$1);
});
...
return (p1__28899_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1504091239048