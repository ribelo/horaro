...
return (new CustomEvent(event_name,(function (){var obj33900 = {"detail":data};
return obj33900;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28806__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28806__auto__)){
var and__28806__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__33907 = cljs.core._EQ_;
var expr__33908 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33907.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33908))){
return ((function (pred__33907,expr__33908){
return (function (p1__33901_SHARP_){
return console.warn(p1__33901_SHARP_);
});
;})(pred__33907,expr__33908))
} else {
if(cljs.core.truth_(pred__33907.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33908))){
return ((function (pred__33907,expr__33908){
return (function (p1__33902_SHARP_){
return console.debug(p1__33902_SHARP_);
});
;})(pred__33907,expr__33908))
} else {
if(cljs.core.truth_(pred__33907.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33908))){
return ((function (pred__33907,expr__33908){
return (function (p1__33903_SHARP_){
return console.error(p1__33903_SHARP_);
});
;})(pred__33907,expr__33908))
} else {
return ((function (pred__33907,expr__33908){
return (function (p1__33904_SHARP_){
return console.log(p1__33904_SHARP_);
});
;})(pred__33907,expr__33908))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33911){
...
var eval_fn = cljs.core.get.call(null,map__33912__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33914_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33916,(0),null);
...
if(cljs.core.truth_((function (){var and__28806__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1504782129523