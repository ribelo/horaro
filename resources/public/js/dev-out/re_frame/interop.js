...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__11168 = cljs.core.instance_QMARK_;
var expr__11169 = reactive_val;
if(cljs.core.truth_(pred__11168.call(null,reagent.ratom.RAtom,expr__11169))){
return "ra";
} else {
if(cljs.core.truth_(pred__11168.call(null,reagent.ratom.RCursor,expr__11169))){
return "rc";
} else {
if(cljs.core.truth_(pred__11168.call(null,reagent.ratom.Reaction,expr__11169))){
return "rx";
} else {
if(cljs.core.truth_(pred__11168.call(null,reagent.ratom.Track,expr__11169))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1504091217931